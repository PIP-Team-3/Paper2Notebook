...
import { generateTests, runTests, streamRunEvents } from '../../../_data/fetchers';
...
export function PlanDetailClient({
	...
	const [testsGenerated, setTestsGenerated] = useState(initialArtifactsExist);
	const [artifactsExist, setArtifactsExist] = useState(initialArtifactsExist);
		...
		<div className="space-y-6">
			...
			<div className="space-y-4 border-t pt-6">
				...
				<Button
					...
					disabled={isGeneratingTests || artifactsExist}
					className="w-full"
				>
					{isGeneratingTests
						? 'Generating Tests...'
